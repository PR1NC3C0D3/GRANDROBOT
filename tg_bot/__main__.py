...
TECHNO_IMG = "https://telegra.ph/Monkey-D-Luffy-04-04-2"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("I am gonna be the king of the pirates!!!")
